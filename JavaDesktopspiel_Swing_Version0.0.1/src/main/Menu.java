...
public class Menu {	
	...
	private MenuButton s_createname;
	private MenuButton s_loadgame;
	private MenuButton s_options;
	
	private MenuSelection o_scaleselection;
	...
	public Menu(Window window, String type){
		if(type == "start"){	
			s_createname = new MenuButton(TextVars.menu_creategame, -64, button_width, button_height, window);
		...
		if(type == "options"){	
			o_scaleselection = new MenuSelection(o_scales, -64, button_width, button_height, window);
